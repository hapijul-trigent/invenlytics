...
if __name__ == '__main__':
    ...
    os.makedirs('data/bronze_layer', exist_ok=True)
    os.makedirs('data/silver_layer', exist_ok=True)
    ...
    training_pipeline.run_xgboost_training_pipeline(
            data_source="data/gold_layer/SupplyChainI_Disruption_Dataset.parquet",
            target_column="Disruption",
        )
    
    
    training_pipeline.run_randomforest_training_pipeline(
            data_source="data/gold_layer/SupplyChainI_Disruption_Dataset.parquet",
            target_column="Disruption",
        )
