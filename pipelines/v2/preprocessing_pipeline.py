...
if __name__ == "__main__":
    ...
    # Define file paths
    input_csv_path = "/workspaces/invenlytics/data/bronze_layer/dynamic_supply_chain_logistics_dataset.csv"
    output_parquet_path = "/workspaces/invenlytics/data/silver_layer/preprocessed_dynamic_supply_chain_logistics_dataset.parquet"
